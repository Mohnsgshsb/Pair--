    ...
    async function initiateSession() {
        ...
        try {
            ...
            const handleQRCode = async (qr) => {
                ...
                console.log('1. افتح واتساب علي هاتف');
                console.log('2. ادخل علي  الاعدادات/Settings > الاجهزه المرتبطه/Linked Devices');
                console.log('3. اضغط علي "Link a Device"');
                console.log('4. امسح البار كود و مبروك عليك الجلسه 🩸.');
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        if (userJid) {
                            ...
                            await sock.sendMessage(userJid, {
                                image: { url: 'https://files.catbox.moe/lk2zqg.jpeg' },
                                caption: `Holla ‚ I'am terbo from team spam and software engineer\n contact me : my accoun's in the web pairing`
                            });
                            console.log("🎬 Video guide sent successfully");
                            
                            // Send warning message
                            await sock.sendMessage(userJid, {
                                text: `نصيحه : لا تشارك هذا الملف مع الاخرين\n 
┌┤✑  شكرا لاسخدامك خدمه Spam-pairing 🕷️
│└────────────┈ ⳹        
│© 2019-2025 Terbo-spam 🩸
└─────────────────┈ ⳹\n\n`
                            });
                        } else {
